        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">
              Poslovni taxi <span className="text-green-600">prevoz</span>
            </h2>
            ...
            <ul className="space-y-3 mb-8">
              {benefits.map((benefit) => (
                <li key={benefit} className="flex items-center gap-3 text-gray-300">
                  <span className="w-5 h-5 bg-green-600/20 rounded-full flex items-center justify-center text-green-600 text-xs flex-shrink-0">✓</span>
                  {benefit}
                </li>
              ))}
            </ul>
            ...
            <Link
              href="/poslovni-taxi"
              className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 text-gray-900 font-bold px-8 py-4 rounded-xl transition-all hover:scale-105"
            >
          ...
          <div className="relative">
            <div className="bg-gray-800 border border-gray-700 rounded-2xl p-8">
              ...
              <div className="mt-6 p-4 bg-green-600/10 border border-green-600/30 rounded-xl text-center">
                <p className="text-green-600 font-semibold text-sm">Kontaktirajte nas za individualnu ponudu</p>
              </div>
            </div>
          </div>
        </div>
